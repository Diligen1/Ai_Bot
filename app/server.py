...
from app.dashboard_data import (
    ...
    get_balance,
    get_binance_account_view,
    get_brain_view,
    get_live_execution_view,
    get_live_risk_view,
    get_live_trading_view,
    get_market_data,
    get_market_symbols,
    get_market_updated,
...
def dashboard(request: Request) -> HTMLResponse:
    return render_page(
        ...
        "dashboard.html",
        {
            ...
            "binance_account": get_binance_account_view(),
            "live_risk": get_live_risk_view(),
            "live_execution": get_live_execution_view(),
            "live_trading": get_live_trading_view(),
